...
export const viewPhotos: Record<string, ViewPhoto> = {
  "aama-yangri-peak--summit-prayer-flags": {
    ...
    credit:
      '"Amayangri Helambu Langtang Sunrise 20250503" by Pratapbaniya, CC BY-SA 4.0, via Wikimedia Commons',
    creditUrl:
      "https://commons.wikimedia.org/wiki/File:Amayangri_Helambu_Langtang_Sunrise_20250503.jpg",
  },
  ...
  "aama-yangri-viewpoint--langtang-panorama": {
    ...
    credit:
      '"Amayangri Helambu Langtang 1 20250503" by Pratapbaniya, CC BY-SA 4.0, via Wikimedia Commons',
  ...
  "badrinath--alpine-temple-town": {
    ...
    credit:
      '"Badrinath Temple, Uttarakhand, India (2012) 15" by Guptaele, CC BY-SA 4.0, via Wikimedia Commons',
    creditUrl:
      "https://commons.wikimedia.org/wiki/File:Badrinath_Temple,_Uttarakhand,_India_(2012)_15.jpg",
  },
  "baglung--baglung-terraces": {
    image: "/photos/views/baglung.jpg",
    alt: "Baglung terraces at Baglung",
    credit:
      '"Baglung" by The original uploader was Sudip khadka at English Wikipedia ., Public domain, via Wikimedia Commons',
  ...
  "chandanbari--laurel-and-rhododendron": {
    ...
    credit:
      '"Ganesh Mountain range seen from Chandanbari, Rasuwa. (By Saroj Pandey)" by Saroj Pandey, CC BY-SA 4.0, via Wikimedia Commons',
    creditUrl:
      "https://commons.wikimedia.org/wiki/File:Ganesh_Mountain_range_seen_from_Chandanbari,_Rasuwa._(By_Saroj_Pandey).jpg",
  },
  ...
  "dharapani--marsyangdi-valley-road": {
    ...
    credit:
      '"The Marsyangdi river at Dharapani - Annapurna Circuit, Nepal - panoramio" by Sergey Ashmarin, CC BY-SA 3.0, via Wikimedia Commons',
    creditUrl:
      "https://commons.wikimedia.org/wiki/File:The_Marsyangdi_river_at_Dharapani_-_Annapurna_Circuit,_Nepal_-_panoramio.jpg",
  },
  ...
  "dhorpatan-hunting-reserve--reserve-landscape": {
    ...
    credit:
      '"Dhorpatan,Dhorpatan Hunting Reserve before Sun Rise" by Ratish Jung Subedi, CC BY-SA 4.0, via Wikimedia Commons',
    creditUrl:
      "https://commons.wikimedia.org/wiki/File:Dhorpatan,Dhorpatan_Hunting_Reserve_before_Sun_Rise.jpg",
  },
  "dhorpatan-meadow--morning-reserve-light": {
    ...
    credit:
      '"ISS064-E-12604 - View of Nepal - Dhaulagiri Himal West - Gurcha Himal - Churen Himal - Putha Hiunchuli - Hiuchuli - Thuli Bheri (Thuibheri) Valley - Gumbatara mountains (cropped)" by Earth Science and Remote Sensing Unit, NASA Johnson Space Center, Public domain, via Wikimedia Commons',
    creditUrl:
      "https://commons.wikimedia.org/wiki/File:ISS064-E-12604_-_View_of_Nepal_-_Dhaulagiri_Himal_West_-_Gurcha_Himal_-_Churen_Himal_-_Putha_Hiunchuli_-_Hiuchuli_-_Thuli_Bheri_(Thuibheri)_Valley_-_Gumbatara_mountains_(cropped).jpg",
  },
  ...
  "diktel-road--terraced-hillside": {
    ...
    credit:
      '"Diktel bazaar 2018-05-12" by Christopher J. Fynn, CC BY-SA 4.0, via Wikimedia Commons',
  ...
  "gaurikund--kedarnath-approach": {
    ...
    credit:
      '"Gaurikund- kedarnath trail" by Prateek as a traveller, CC BY-SA 4.0, via Wikimedia Commons',
  ...
  "gosaikunda--sacred-lake": {
    ...
    credit:
      '"Gosaikunda lake, Nepal U5A3309-Pano" by Nrik kiran, CC BY-SA 4.0, via Wikimedia Commons',
  ...
  "green-lake--quiet-alpine-water": {
    ...
    credit:
      '"Tilicho lake, World\'s Highest Lake" by Prabeshsdev, CC BY-SA 4.0, via Wikimedia Commons',
  ...
  "halesi-hill--limestone-landscape": {
    ...
    credit:
      '"Halesi Mahadev Temple Cave" by Roshan Raj Adhikari, CC BY-SA 4.0, via Wikimedia Commons',
  ...
  "kalinchowk--cable-car-ridge": {
    ...
    credit:
      '"Kalinchowk Bhagwati Temple or Kalinchok Mai Suippa Village Kuri Village Kalinchowk Dolakha Nepal Rajesh Dhungana (51)" by Rajesh Dhungana, CC BY-SA 4.0, via Wikimedia Commons',
    creditUrl:
      "https://commons.wikimedia.org/wiki/File:Kalinchowk_Bhagwati_Temple_or_Kalinchok_Mai_Suippa_Village_Kuri_Village_Kalinchowk_Dolakha_Nepal_Rajesh_Dhungana_(51).jpg",
  },
  "kalinchowk-bhagwati--temple-above-the-clouds": {
    image: "/photos/views/kalinchowk-bhagwati-temple-or-kalinchok-mai-suippa-village-k.jpg",
    alt: "Temple above the clouds at Kalinchowk Bhagwati",
    credit:
      '"Kalinchowk Bhagwati Temple or Kalinchok Mai Suippa Village Kuri Village Kalinchowk Dolakha Nepal Rajesh Dhungana (52)" by Rajesh Dhungana, CC BY-SA 4.0, via Wikimedia Commons',
    creditUrl:
      "https://commons.wikimedia.org/wiki/File:Kalinchowk_Bhagwati_Temple_or_Kalinchok_Mai_Suippa_Village_Kuri_Village_Kalinchowk_Dolakha_Nepal_Rajesh_Dhungana_(52).jpg",
  },
  ...
  "khotang--hill-road-approach": {
    ...
    credit:
      '"From Tyamke Peak 3010mtrs Khotang Bhojpur" by Raishreekumar, CC BY-SA 3.0, via Wikimedia Commons',
    creditUrl:
      "https://commons.wikimedia.org/wiki/File:From_Tyamke_Peak_3010mtrs_Khotang_Bhojpur.JPG",
  },
  "khotang-viewpoint--sunrise-over-the-hills": {
    ...
    credit:
      '"Tyamke Peak 3010mtrs Khotang Bhojpur" by Raishreekumar, CC BY-SA 3.0, via Wikimedia Commons',
  ...
  "kuri-village--kuri-village-lights": {
    ...
    credit:
      '"Kalinchowk Bhagwati Temple or Kalinchok Mai Suippa Village Kuri Village Kalinchowk Dolakha Nepal Rajesh Dhungana (49)" by Rajesh Dhungana, CC BY-SA 4.0, via Wikimedia Commons',
    creditUrl:
      "https://commons.wikimedia.org/wiki/File:Kalinchowk_Bhagwati_Temple_or_Kalinchok_Mai_Suippa_Village_Kuri_Village_Kalinchowk_Dolakha_Nepal_Rajesh_Dhungana_(49).jpg",
  },
  "lauribina--high-pass-viewpoint": {
    ...
    credit:
      '"Paints of sunrise on Langtang National Park" by Q-lieb-in, CC BY-SA 4.0, via Wikimedia Commons',
    creditUrl:
      "https://commons.wikimedia.org/wiki/File:Paints_of_sunrise_on_Langtang_National_Park.jpg",
  },
  "mahadev-courtyard--evening-prayer": {
    ...
    credit:
      '"Indreshwor Mahadev Temple (श्री इन्द्रेश्वोर महादेव मन्दिर) courtyard, Panauti, Kavrepalanchowk" by Shadow Ayush, CC BY-SA 4.0, via Wikimedia Commons',
    creditUrl:
      "https://commons.wikimedia.org/wiki/File:Indreshwor_Mahadev_Temple_(%E0%A4%B6%E0%A5%8D%E0%A4%B0%E0%A5%80_%E0%A4%87%E0%A4%A8%E0%A5%8D%E0%A4%A6%E0%A5%8D%E0%A4%B0%E0%A5%87%E0%A4%B6%E0%A5%8D%E0%A4%B5%E0%A5%8B%E0%A4%B0_%E0%A4%AE%E0%A4%B9%E0%A4%BE%E0%A4%A6%E0%A5%87%E0%A4%B5_%E0%A4%AE%E0%A4%A8%E0%A5%8D%E0%A4%A6%E0%A4%BF%E0%A4%B0)_courtyard,_Panauti,_Kavrepalanchowk.jpg",
  },
  ...
  "marpha--apple-capital": {
    ...
    credit:
      '"Mustang-Marpha-08-Schranktransport-2015-gje" by Gerd Eichmann, CC BY-SA 4.0, via Wikimedia Commons',
    creditUrl:
      "https://commons.wikimedia.org/wiki/File:Mustang-Marpha-08-Schranktransport-2015-gje.jpg",
  },
  ...
  "myagdi-highlands--forest-road": {
    ...
    credit:
      '"Panorama from poonhill-2019-BJ" by Bijay Chaurasia, CC BY-SA 4.0, via Wikimedia Commons',
  ...
  "octopus-waterfall--waterfall-stop": {
    ...
    credit:
      '"Waterfall and bridge, Annapurna Circuit" by Greg Willis, CC BY-SA 2.0, via Wikimedia Commons',
    creditUrl:
      "https://commons.wikimedia.org/wiki/File:Waterfall_and_bridge,_Annapurna_Circuit.jpg",
  },
  "pathivara-devi--pathibhara-ridge": {
    ...
    credit:
      '"Power of Goddess "Pathivara Devi"" by Bandana kc, CC BY-SA 3.0, via Wikimedia Commons',
  ...
  "pathivara-trail--cloud-sea-viewpoint": {
    ...
    credit:
      '"Mt.Kanchanjunga from Pathibhara Devi Temple" by CHIRONEX XEN, CC BY-SA 4.0, via Wikimedia Commons',
    creditUrl:
      "https://commons.wikimedia.org/wiki/File:Mt.Kanchanjunga_from_Pathibhara_Devi_Temple.jpg",
  },
  ...
  "pokhara--lake-and-mountain-reflections": {
    ...
    credit:
      '"Phewa Lake in Pokhara (15715573565)" by Jean-Marie Hullot from France, CC BY 2.0, via Wikimedia Commons',
  ...
  "pokhara--lakeside-opening": {
    ...
    credit:
      '"Cloudy Sunrise from Pokhara" by Arjun Gurung Pokhara, CC BY-SA 4.0, via Wikimedia Commons',
  ...
  "ranikhet--mountain-river-road": {
    ...
    credit:
      '"Golu Devta Udepur, Binta, Ranikhet." by Enjoymusic nainital, CC BY-SA 3.0, via Wikimedia Commons',
  ...
  "rishikesh--river-confluence": {
    ...
    credit:
      '"Boat on the Ganges near Lakshman Jhula, Rishikesh, Uttarakhand, India" by Dan Searle, CC BY-SA 2.0, via Wikimedia Commons',
    creditUrl:
      "https://commons.wikimedia.org/wiki/File:Boat_on_the_Ganges_near_Lakshman_Jhula,_Rishikesh,_Uttarakhand,_India.jpg",
  },
  "rupse-jharna--waterfall-in-the-gorge": {
    ...
    credit:
      '"Rupse Fall, Myagdi District-WLV-1457" by Aasish Shah, CC BY-SA 4.0, via Wikimedia Commons',
  ...
  "sailung--hundred-hills-sunrise": {
    ...
    credit:
      '"Clear sunrise at Sailung, Nepal" by Anupama Pandeya, CC BY-SA 4.0, via Wikimedia Commons',
  ...
  "sailung-ridge--dawn-across-central-nepal": {
    ...
    credit:
      '"Sunpension Bridge Jholujnge Pool Tunitar Khare Gaurishankar VDC Dolakha Nepal Rajesh Dhungana (03)" by Rajesh Dhungana, CC BY-SA 4.0, via Wikimedia Commons',
    creditUrl:
      "https://commons.wikimedia.org/wiki/File:Sunpension_Bridge_Jholujnge_Pool_Tunitar_Khare_Gaurishankar_VDC_Dolakha_Nepal_Rajesh_Dhungana_(03).jpg",
  },
  ...
  "shanti-stupa--panorama-from-the-ridge": {
    ...
    credit:
      '"World peace pagoda or Shanti Stupa pokhra" by Goutam1962, CC BY-SA 4.0, via Wikimedia Commons',
    creditUrl:
      "https://commons.wikimedia.org/wiki/File:World_peace_pagoda_or_Shanti_Stupa_pokhra.jpg",
  },
  ...
  "sing-gompa--yak-cheese-country": {
    ...
    credit:
      '"Travellers heading towards Gosainkunda Lake after crossing Lauri Binayak, Rasuwa. Mountain in the back is Langtang Lirung. (By Saroj Pandey)" by Saroj Pandey, CC BY-SA 4.0, via Wikimedia Commons',
    creditUrl:
      "https://commons.wikimedia.org/wiki/File:Travellers_heading_towards_Gosainkunda_Lake_after_crossing_Lauri_Binayak,_Rasuwa._Mountain_in_the_back_is_Langtang_Lirung._(By_Saroj_Pandey).jpg",
  },
  "sukute-beach--river-recreation": {
    ...
    credit:
      '"Balephi River in Balephi Rural Municipality" by Saddam19, CC BY-SA 4.0, via Wikimedia Commons',
    creditUrl:
      "https://commons.wikimedia.org/wiki/File:Balephi_River_in_Balephi_Rural_Municipality.jpg",
  },
  ...
  "tarkeghyang--helambu-trailhead": {
    ...
    credit:
      '"Tarkeghyang Helambu Road Amayangri 20250502" by Pratapbaniya, CC BY-SA 4.0, via Wikimedia Commons',
    creditUrl:
      "https://commons.wikimedia.org/wiki/File:Tarkeghyang_Helambu_Road_Amayangri_20250502.jpg",
  },
  "tarkeghyang-village--monastery-landscape": {
    ...
    credit:
      '"Amayangri Helambu Langtang Himalayan Range 1 20250503" by Pratapbaniya, CC BY-SA 4.0, via Wikimedia Commons',
    creditUrl:
      "https://commons.wikimedia.org/wiki/File:Amayangri_Helambu_Langtang_Himalayan_Range_1_20250503.jpg",
  },
